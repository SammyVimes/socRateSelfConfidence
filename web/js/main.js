var TestController = function()
{
	...
	*/
	...
	var matrixTexts = [
		{title: "Положительный эталон", text: "Бла-бла про положительный эталон", id: "p"},
		{title: "Отрицательный эталон", text: "Бла-бла про отрицательный эталон", id: "n"},
		{title: "Я сам", text: "Бла-бла про себя", id: "s"}
	];
	var formQuestions = [
		...
		{id: "company_type", question: "С какими предприятиями преимущественно связан Ваш опыт работы:", answers: ["Госучреждения (образование, медицина, армия и др.)", "ООО", "ОАО", "ЗАО", "ИП", "Сельхозпредприятия"], specific: 0},
